  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Pay Delivery boy collect amount</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Delivery boy</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Pay Delivery boy collect amount</a></li>
         </ol>
	   </div>
	   <div class="col-sm-3">
       <div class="float-sm-right">
        <a href="<?php echo base_url();?>customer/delivery_boy"> 
         <button type="button" class="btn btn-primary waves-effect waves-light m-1">Back</button>
        </a> 
      </div>
     </div>
     </div>
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-upload"></i> Pay Delivery boy collect amount</div>
            <div class="card-body">
			  <form id="pay_amt" method="post" action="<?php echo base_url();?>customer/add_payment_data1">
                <div id="wizard-vertical1">
                    
                    <section>
                        <div class="form-group row">
						  <div class="col-md-3">
                            <label> Current Collect Amount*</label>
                            <input class="form-control" name="current_bal" value="<?php echo $db->wallet; ?>" type="text" readonly>
						  ...
						  <hr>
							 ...
							 <div class="form-group row">
								 <label class="control-label col-sm-2"> <strong style="font-size:16px">Payment Option</strong></label>
								 </div>
								 <hr/>
							    <div class="form-group row">
								 <label for="horizontalFormPassword" class="col-sm-2 control-label"> Payment Mode</label>
								  <div class="col-sm-4">
								   <select  name="payment_mode" class="form-control single-select" tabindex="-1" onchange="admSelectCheck(this);">
                     ...
                     <input type="hidden" class="form-control" name="db_id" value="<?= ($db->db_id); ?>">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-check-square-o"></i>Pay</button>
