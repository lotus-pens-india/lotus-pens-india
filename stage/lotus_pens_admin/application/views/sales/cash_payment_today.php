  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Today Cash Payment</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Payment</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Today Cash Payment Tables</a></li>
            <li class="breadcrumb-item active" aria-current="page">Today Cash Payment Data Tables</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
    ...
    <!-- End Breadcrumb-->
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Today Cash Payment List</div>
            <div class="card-body">
