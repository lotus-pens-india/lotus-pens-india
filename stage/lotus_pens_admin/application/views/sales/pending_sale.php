  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item"><a href="javaScript:void();">Pending Order Tables</a></li>
            <li class="breadcrumb-item active" aria-current="page">Pending Order Data Tables</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Pending Order List <button type="button" class="btn btn-info send_all" style="float:right;margin-bottom:13px">Dispatch Order</button>
              <div class="float-sm-right" style="margin-top: -3px;">
                 <form id="add_product" method="post" action="<?php echo base_url();?>sales/download_pending_order_excel">
            ...
            <div class="card-body">
              ...
              <table id="pending_sale_datatable" class="table table-bordered">
                <thead>
                    <tr>
  ...
  <div class="modal-dialog">
	<div class="modal-content">
	  <div class="modal-header">
		<h5 class="modal-title"><i class="fa fa-star"></i>Dispatch Order</h5>
		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		  <span aria-hidden="true">&times;</span>
		</button>
	  </div>
	   <form id="add_banner" method="post" action="<?php echo base_url();?>sales/dispatch_product_order_data">
		  <div class="modal-body">
		     	<h5 class="modal-title"><i class="fa fa-star"></i>Are you sure you want to dispatch this order.</h5>
