  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item"><a href="javaScript:void();">Offer Tables</a></li>
            <li class="breadcrumb-item active" aria-current="page">Offer Data Tables</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
       <div class="float-sm-right">
        <?php $login_type   = $this->session->userdata('type');  if($login_type !='0') { ?>   
          <button type="button" class="btn btn-primary waves-effect waves-light m-1" data-toggle="modal" data-target="#defaultsizemodal">Add Offer</button>
        <?php } ?>  
      </div>
     </div>
     </div>
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Offer List</div>
            <div class="card-body">
              ...
              <table id="brand-datatable" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
						...
						<?php } else { ?>
						    <a href="<?php echo base_url('assets/images/offer/'.$offer->image);?>" data-fancybox="images" data-caption="This image has a caption">
							  <img src="<?php echo base_url('assets/images/offer/'.$offer->image);?>" alt="lightbox" class="lightbox-thumb img-thumbnail" style="width: 100px;">
							</a>
						<?php } ?>
						</td>
						<td>
						  <a href="<?php echo base_url('product/update_offer?offer_id='.$offer->offer_id)?>">
						       <button type="button" class="btn btn-secondary waves-effect waves-light m-1"> <i class="fa fa-edit"></i> </button>
						  </a>
  
						 <a style="cursor:pointer;"  class="tip-top delete delete one_<?php echo  $offer->offer_id; ?>" data-original-title="Delete" id="<?php echo $offer->offer_id; ?>"
						      Onclick="return ConfirmDelete(<?php echo $offer->offer_id; ?>);">
  ...
  <div class="modal-dialog">
	<div class="modal-content">
	  <div class="modal-header">
		<h5 class="modal-title"><i class="fa fa-star"></i> Add Offer</h5>
		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
		  <span aria-hidden="true">&times;</span>
		</button>
	  </div>
	   <form id="add_subcategory" method="post" action="<?php echo base_url();?>product/add_offer_data" enctype="multipart/form-data">
		  <div class="modal-body">
			 ...
			 <div class="form-group">
			  ...
			  <label for="input-1">Image</label>
				<input type="file" class="form-control" name="image" id="input-1" required>
...
if(confirm("Are you sure you want to delete this Record?"))
{
	...
	$.ajax({
	   type: "POST",
	   url: "<?php echo base_url();?>product/delete_offer",
	   data: {'delete_id':id},
		   success : function(id) {
