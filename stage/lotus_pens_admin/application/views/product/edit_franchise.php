  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Update Saller</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Saller</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Update Saller Tables</a></li>
            <li class="breadcrumb-item active" aria-current="page">Update Saller Data Tables</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
       <div class="float-sm-right">
         <a href="<?php echo base_url();?>product/franchise">  
          <button type="button" class="btn btn-primary waves-effect waves-light m-1">Saller List</button>
         </a> 
      </div>
     </div>
     </div>
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Saller From</div>
            <div class="card-body">
                <form id="add_emp" method="post" action="<?php echo base_url();?>product/update_franchise_data" enctype="multipart/form-data">
    				  
    				<div class="form-group row">
    					<label for="horizontalFormEmail" class="col-sm-2 control-label">Franchise Name : <span style="color:red">*</span></label>
    					<div class="col-sm-4">
    						<input type="text" class="form-control" id="franchise_name" name="franchise_name" placeholder="Franchise Name " value="<?php echo $franchise->franchise_name ?>">
    					...
    					<div class="col-sm-4">
    						<input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile No" value="<?php echo $franchise->mobile_no ?>">
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="email_id" name="email_id" placeholder="Email id" value="<?php echo $franchise->email_id ?>">
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
							<select class="form-control single-select"   name="state" id="state_id">
        							<option value="<?php echo $franchise->state ?>"><?php echo $franchise->state_name ?></option>
        							<?php
						...
						<div class="col-sm-4">
							<select class="form-control single-select"   name="city" id="city_id">
							    <option value="<?php echo $franchise->city ?>"><?php echo $franchise->city_name ?></option>
						        </select>
						...
						<div class="col-sm-4">
							<textarea type="text" class="form-control" id="address" name="address" placeholder="Address"><?php echo $franchise->address ?></textarea>
					 ...
					 <br>
					 <input type="hidden" class="form-control" id="franchise_id" name="franchise_id"  value="<?php echo $franchise->franchise_id ?>">
					<div class="form-group row">
						<div class="col-sm-12">
