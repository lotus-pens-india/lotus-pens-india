...
*********************************************************************************/
   ...
   /****************************** employee View Page **************/
    ...
    public function add_employee_data()
	{
		...
		$d_master             = $this->input->post('d_master');if($this->input->post('d_master') !=""){ $d_master = 'Y'; }else { $d_master = 'N'; }
		$e_master             = $this->input->post('e_master');if($this->input->post('e_master') !=""){ $e_master = 'Y'; }else { $e_master = 'N'; }
		$z_master             = $this->input->post('z_master');if($this->input->post('z_master') !=""){ $z_master = 'Y'; }else { $z_master = 'N'; }
		$a_master             = $this->input->post('a_master');if($this->input->post('a_master') !=""){ $a_master = 'Y'; }else { $a_master = 'N'; }
		$banner               = $this->input->post('banner');if($this->input->post('banner') !=""){ $banner = 'Y'; }else { $banner = 'N'; }
		$brand                = $this->input->post('brand');if($this->input->post('brand') !=""){ $brand = 'Y'; }else { $brand = 'N'; }
		$category             = $this->input->post('category');if($this->input->post('category') !=""){ $category = 'Y'; }else { $category = 'N'; }
		$subcategory          = $this->input->post('subcategory');if($this->input->post('subcategory') !=""){ $subcategory = 'Y'; }else { $subcategory = 'N'; }
		$sub_subcategory      = $this->input->post('sub_subcategory');if($this->input->post('sub_subcategory') !=""){ $sub_subcategory = 'Y'; }else { $sub_subcategory = 'N'; }
		$slot                 = $this->input->post('slot');if($this->input->post('slot') !=""){ $slot = 'Y'; }else { $slot = 'N'; }
		$pickup               = $this->input->post('pickup');if($this->input->post('pickup') !=""){ $pickup = 'Y'; }else { $pickup = 'N'; }
		$pincode              = $this->input->post('pincode');if($this->input->post('pincode') !=""){ $pincode = 'Y'; }else { $pincode = 'N'; }
		$coupon               = $this->input->post('coupon');if($this->input->post('coupon') !=""){ $coupon = 'Y'; }else { $coupon = 'N'; }
		$minlimit             = $this->input->post('minlimit');if($this->input->post('minlimit') !=""){ $minlimit = 'Y'; }else { $minlimit = 'N'; }
		$olimit               = $this->input->post('olimit');if($this->input->post('olimit') !=""){ $olimit = 'Y'; }else { $olimit = 'N'; }
		$u_product            = $this->input->post('u_product');if($this->input->post('u_product') !=""){ $u_product = 'Y'; }else { $u_product = 'N'; }
		$l_product            = $this->input->post('l_product');if($this->input->post('l_product') !=""){ $l_product = 'Y'; }else { $l_product = 'N'; }
		$stock_update         = $this->input->post('stock_update');if($this->input->post('stock_update') !=""){ $stock_update = 'Y'; }else { $stock_update = 'N'; }
		$price_update         = $this->input->post('price_update');if($this->input->post('price_update') !=""){ $price_update = 'Y'; }else { $price_update = 'N'; }
		$manually             = $this->input->post('manually');if($this->input->post('manually') !=""){ $manually = 'Y'; }else { $manually = 'N'; }
		$t_order              = $this->input->post('t_order');if($this->input->post('t_order') !=""){ $t_order = 'Y'; }else { $t_order = 'N'; }
		$to_order             = $this->input->post('to_order');if($this->input->post('to_order') !=""){ $to_order = 'Y'; }else { $to_order = 'N'; }
		$p_order              = $this->input->post('p_order');if($this->input->post('p_order') !=""){ $p_order = 'Y'; }else { $p_order = 'N'; }
		$i_order              = $this->input->post('i_order');if($this->input->post('i_order') !=""){ $i_order = 'Y'; }else { $i_order = 'N'; }
		$a_order              = $this->input->post('a_order');if($this->input->post('a_order') !=""){ $a_order = 'Y'; }else { $a_order = 'N'; }
		$a_n_order            = $this->input->post('a_n_order');if($this->input->post('a_n_order') !=""){ $a_n_order = 'Y'; }else { $a_n_order = 'N'; }
		$dis_order            = $this->input->post('dis_order');if($this->input->post('dis_order') !=""){ $dis_order = 'Y'; }else { $dis_order = 'N'; }
		$d_order              = $this->input->post('d_order');if($this->input->post('d_order') !=""){ $d_order = 'Y'; }else { $d_order = 'N'; }
		$c_order              = $this->input->post('c_order');if($this->input->post('c_order') !=""){ $c_order = 'Y'; }else { $c_order = 'N'; }
		$cc_order             = $this->input->post('cc_order');if($this->input->post('cc_order') !=""){ $cc_order = 'Y'; }else { $cc_order = 'N'; }
		$r_order              = $this->input->post('r_order');if($this->input->post('r_order') !=""){ $r_order = 'Y'; }else { $r_order = 'N'; }
		$t_subscribe          = $this->input->post('t_subscribe');if($this->input->post('t_subscribe') !=""){ $t_subscribe = 'Y'; }else { $t_subscribe = 'N'; }
		$n_subscribe          = $this->input->post('n_subscribe');if($this->input->post('n_subscribe') !=""){ $n_subscribe = 'Y'; }else { $n_subscribe = 'N'; }
		$to_subscribe         = $this->input->post('to_subscribe');if($this->input->post('to_subscribe') !=""){ $to_subscribe = 'Y'; }else { $to_subscribe = 'N'; }
		$a_subscribe          = $this->input->post('a_subscribe');if($this->input->post('a_subscribe') !=""){ $a_subscribe = 'Y'; }else { $a_subscribe = 'N'; }
		$p_subscribe          = $this->input->post('p_subscribe');if($this->input->post('p_subscribe') !=""){ $p_subscribe = 'Y'; }else { $p_subscribe = 'N'; }
		$en_subscribe         = $this->input->post('en_subscribe');if($this->input->post('en_subscribe') !=""){ $en_subscribe = 'Y'; }else { $en_subscribe = 'N'; }
		$e_subscribe          = $this->input->post('e_subscribe');if($this->input->post('e_subscribe') !=""){ $e_subscribe = 'Y'; }else { $e_subscribe = 'N'; }
		$customer             = $this->input->post('customer');if($this->input->post('customer') !=""){ $customer = 'Y'; }else { $customer = 'N'; }
		$deliver_list         = $this->input->post('deliver_list');if($this->input->post('deliver_list') !=""){ $deliver_list = 'Y'; }else { $deliver_list = 'N'; }
		$delivery_recevied_p  = $this->input->post('delivery_recevied_p');if($this->input->post('delivery_recevied_p') !=""){ $delivery_recevied_p = 'Y'; }else { $delivery_recevied_p = 'N'; }
		$t_payment            = $this->input->post('t_payment');if($this->input->post('t_payment') !=""){ $t_payment = 'Y'; }else { $t_payment = 'N'; }
		$c_payment            = $this->input->post('c_payment');if($this->input->post('c_payment') !=""){ $c_payment = 'Y'; }else { $c_payment = 'N'; }
		$o_payment            = $this->input->post('o_payment');if($this->input->post('o_payment') !=""){ $o_payment = 'Y'; }else { $o_payment = 'N'; }
		$r_payment            = $this->input->post('r_payment');if($this->input->post('r_payment') !=""){ $r_payment = 'Y'; }else { $r_payment = 'N'; }
		$s_report             = $this->input->post('s_report');if($this->input->post('s_report') !=""){ $s_report = 'Y'; }else { $s_report = 'N'; }
		$p_report             = $this->input->post('p_report');if($this->input->post('p_report') !=""){ $p_report = 'Y'; }else { $p_report = 'N'; }
		$sms_customer         = $this->input->post('sms_customer');if($this->input->post('sms_customer') !=""){ $sms_customer = 'Y'; }else { $sms_customer = 'N'; }
		$sms_db               = $this->input->post('sms_db');if($this->input->post('sms_db') !=""){ $sms_db = 'Y'; }else { $sms_db = 'N'; }
		$warehouse               = $this->input->post('warehouse');if($this->input->post('warehouse') !=""){ $warehouse = 'Y'; }else { $warehouse = 'N'; }
		
		
		$supplier               = $this->input->post('supplier');if($this->input->post('supplier') !=""){ $supplier = 'Y'; }else { $supplier = 'N'; }
		$purchse_entry               = $this->input->post('purchse_entry');if($this->input->post('purchse_entry') !=""){ $purchse_entry = 'Y'; }else { $purchse_entry = 'N'; }
		$purchse_list               = $this->input->post('purchse_list');if($this->input->post('purchse_list') !=""){ $purchse_list = 'Y'; }else { $purchse_list = 'N'; }
		$stock_list               = $this->input->post('stock_list');if($this->input->post('stock_list') !=""){ $stock_list = 'Y'; }else { $stock_list = 'N'; }
