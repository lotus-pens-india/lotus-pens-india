                ...
                foreach ($posts as $post)
                {
                    ...
                    $nestedData['action'] = ' <div class="btn-group m-1" role="group">
                                              ...
                                              <div class="dropdown-menu">
                                                <a href="'.base_url('sales/edit_order?order_id='.$post->order_generate_id).'" class="dropdown-item" target="_blank"><i aria-hidden="true" class="fa fa-edit"></i> Edit</a>
                                                <a href="'.base_url('sales/assign_order?order_id='.$post->order_generate_id).'" class="dropdown-item" target="_blank"><i aria-hidden="true" class="fa fa-user"></i> Assign</a>
