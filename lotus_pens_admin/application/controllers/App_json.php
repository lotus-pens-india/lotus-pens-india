...
class App_json extends CI_Controller
{
    ...
    *****************************************************************************************************************************/
	...
	public function customer_registration()
	{
        ...
        $apply_rc = $this->input->post('apply_rc');
        ...
        if($apply_rc == '')
        {
    	    ...
    	    if($rowcount == 0)
    		{
                ...
                $uid='C'.str_pad($insert_id,8,0,STR_PAD_LEFT);
                $insertArray1 = array
                (
        ...
        elseif($apply_rc != '')
        {
    	    ...
    	    if($rowcount == 0)
    		{
                    ...
                    $this->db->select('*');
            		$this->db->from('customer');
            		$this->db->where('referral_code', $apply_rc );
            		$this->db->where('flag', '0' );
            		$query1  = $this->db->get();
    ...
    public function banner_list()
	{
	    ...
	    if(!empty($banner_list))
        {
    	    foreach ($banner_list as $banner)
    		{
    		    ...
    		    $banner1= 'assets/images/banner/'.$banner1;
    ...
    public function category_list()
	{
	    ...
	    if(!empty($category_list))
        {
    	    foreach ($category_list as $category)
    		{
    		    ...
    		    if($icon !='')
    		    {
        		    $icon = 'assets/images/category/'.$icon;
    		        $image = base_url($icon);
    		    }
    		    else
    		    {
    		    ...
    		    $data[]=array('category_id'=>$category_id,'category_name'=>$category_name,'image'=>$image,'subcategorey'=>$subcategorey,'subcategorey'=>$subcategorey,'color'=>$color);
    		}
	             echo json_encode(array('status'=>'1','result'=>$data,'result'=>$data,'version_code'=>$version_code));
	    }
	    else
	    {
	        $msg = 'No Record Found.';
    ...
    public function subcategory_list()
	{
	    ...
	    if(!empty($subcategory_list))
        {
    	    foreach ($subcategory_list as $subcategory)
    		{
    		    ...
    		    $icon = 'assets/images/subcategory/'.$icon;
		        $image = base_url($icon);
    ...
    public function sub_subcategory_list()
	{
	    ...
	    if(!empty($subcategory_list))
        {
    	    foreach ($subcategory_list as $subcategory)
    		{
    		    ...
    		    $icon = 'assets/images/sub_subcategory/'.$icon;
		        $image = base_url($icon);
    ...
    public function product_list()
	{
	    ...
	    if(!empty($product_list))
        {
    	    foreach ($product_list as $product)
    		{
    		    ...
    		    $main_image = 'assets/images/product/'.$main_image;
          ...
          if(!empty($thumbnail_image))
           {
                ...
                foreach ($var as $item) 
                {
    	            $thumbnail_image = 'assets/images/thumbnail/'.$item;
...
********************************************************************************************************************************/
	    ...
	    $current_day = date('l', strtotime($timestamp . ' +1 day'));
    	    ...
    	    if(!empty($product_list))
            {
        	    ...
        	    foreach ($product_list as $product)
        		{
        		    ...
        		    $data[]=array('product_id'=>$product_id,'product_name'=>$product_name,'unit'=>$unit,'unit_price'=>$price,'price'=>$total_price,'qty'=>$qty,'discount'=>$discount,'price1'=>$discount_price,'discount_amt'=>$discount_amt,'image'=>$image,'qty'=>$qty,'cart_id'=>$cart_id);
        		   ...
        		   $bag_details[] = array('total_bag' => $sum,'bag_discount' => $bag_discount,'order_total' => $order_total + $delivery_charges,'delivery_charges'=>$delivery_charges);
        		  ...
        		  // print_r($slot_list);exit;
    	           ...
    	           echo json_encode(array('status'=>'1','result'=>$data,'bag_details'=>$bag_details,'slot'=>$slot_details));
    	    }
    	    else
    	    {
    	        $msg = 'No Record Found.';
    ...
    *******************************************************************************************************************/
	...
	{
        $franchise_id  = $this->input->post('franchise_id');
	    $coupon_list = $this->product_model->get_all_coupon_model1($franchise_id);
	    $i = 1;
    ...
    ********************************************************************************************************************/
	...
	public function customer_address()
	{
        ...
        $this->db->insert('customer_address', $regData);
    ...
    ******************************************************************************************************************/
	...
	public function customer_address_update()
	{
        ...
        $this->db->where(array('id' => $id))->update('customer_address', $regData);
    ...
    public function offer_list()
	{
	    ...
	    if(!empty($offer_list))
        {
    	    foreach ($offer_list as $offer)
    		{
    		    ...
    		    $main_image = 'assets/images/offer/'.$offer_image;
		        $image = base_url($main_image);
    ...
    public function login_delivery_boy()
    {
	    ...
	    if($rowcount > 0)
		{
		    ...
		    else
		    {
		        ...
		        $photo= 'assets/images/deliver_boy/'.$photo;
		        $img= base_url($photo);
		    }
    ...
    public function hot_product_list()
	{
	    ...
	    if(!empty($hot_product_list))
        {
    	    foreach ($hot_product_list as $product)
    		{
    		    ...
    		    $image1= 'assets/images/hot_product/'.$image1;
    ...
    public function notification_list()
	{
	    ...
	    if(!empty($notification_list))
        {
    	    foreach ($notification_list as $notification)
    		{
    		    ...
    		    if($image1 !='')
    		    {
    		      $image1= 'assets/images/notification/'.$image1;
		          $image= base_url($image1);
    		    }
    		    else
    		    {
