     ...
     $(document).ready(function() {
      //Default data table
	   ...
	   var max_fields = 15; //maximum input boxes allowed
		...
		$(wrapper).append('<div class="row" style="margin-top: 10px;"><div class="col-md-2"><input class="form-control" type="text" name="title[]" placeholder="Title"></div><div class="col-md-2"><input class="form-control" type="text" name="unit_price[]" placeholder="Unit Price"></div><div class="col-md-2"><select class="form-control single-select"  name="inc_exc[]" ><option value="Inclusion">Inclusion</option> <option value="Exclusion">Exclusion</option></select></div><div class="col-md-2"><input class="form-control" type="text" name="discount[]" placeholder="Discount"></div><div class="col-md-2"><input class="form-control" type="text" name="purchse_price[]" placeholder="Purchse Price"></div><div style="background-color:red;height: 40px;width: 100px;margin-left: 12px;" class="remove_field btn btn-info">Remove</div></div>'); //add input box
		}
		});
