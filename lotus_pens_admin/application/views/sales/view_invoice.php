                  ...
                  <section class="invoice">
                    ...
                    <div class="row invoice-info">
                      ...
                      <div class="col-sm-4 invoice-col">
                        ...
                        <br>
                        <b>Payment Mode:</b><?php if($order_summary->p_mode == '0'){ echo 'Cash on delivery'; } elseif($order_summary->p_mode == '1') { echo 'Online payment';} elseif($order_summary->p_mode == '3') { echo 'Wallet';} ?><br>
                        <b>ZONE : <?php echo $order_summary->zone_name; ?></b><br>
                        <b>Slot : 
                        <?php 
                                 $CI =& get_instance();
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                  ...
                                  { 
                                    $b = $p_detail->discount * $p_detail->qty; $sum+= $a - $b;  echo $sub_total = $a - $b; 
                                  } 
                                  else 
                                  { 
                        ...
                        <div class="table-responsive">
                          <table class="table">
							...
							<tr>
                              ...
                              <td>Rs. <?php echo $order_summary->total_bag; ?></td>
                            </tr>
                            <tr>
                              <th>Total Savings :</th>
                              <td>Rs. <?php echo round($order_summary->bag_discount); ?></td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td>Rs. <?php echo $order_summary->total_bag - round($order_summary->bag_discount) - $order_summary->wallet_use ; ?></td>
                            </tr>
                            <tr>
                              <th>Delivery Charge :</th>
                              <td> <?php if($order_summary->delivery_charges == '0') { echo 'Free'; } else { ?>Rs. <?php echo round($order_summary->delivery_charges).' '.'+'; }?></td>
                            </tr>
                    ...
                    <hr>
                    <?php if($order_summary->assign_to != '') { ?>
                      ...
                      <div class="col-lg-6">
                         <h5>Assign To : 
                           <?php 
                            ...
                            $CI =& get_instance();
                            $CI->load->model('Product_model');
                            $result = $CI->product_model->assign_to_details($order_summary->assign_to);
                            //print_r($result);
                            echo $result->name;
                           ?>
                         
                         </h5><br>
                         <h5>Assign Date : <?php echo $order_summary->assign_date; ?></h5>
						</div>
						<div class="col-lg-6">
