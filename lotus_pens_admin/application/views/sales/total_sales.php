  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Total Order</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Sales</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Total Order Tables</a></li>
            <li class="breadcrumb-item active" aria-current="page">Total Order Data Tables</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
    ...
    <!-- End Breadcrumb-->
          ...
          <div class="card border-info border-left-sm">
            <div class="card-body">
              ...
              <div class="media-body text-left">
                <h4 class="text-info"><?php if($pending_count->pending_count == '') { echo '0'; } else { echo $pending_count->pending_count; } ?></h4>
        ...
        <div class="col-12 col-lg-6 col-xl-4">
         <a href="<?php echo base_url();?>sales/deliver_sales">    
          <div class="card border-success border-left-sm">
            <div class="card-body">
              <div class="media">
              <div class="media-body text-left">
                <h4 class="text-success"><?php if($delivered_count->delivered_count == '') { echo '0'; } else { echo $delivered_count->delivered_count; } ?></h4>
         ...
         <a href="<?php echo base_url();?>sales/cancel_sales">    
          <div class="card border-warning border-left-sm">
            <div class="card-body">
              <div class="media">
              <div class="media-body text-left">
                <h4 class="text-danger"><?php if($cancel_count->cancel_count == '') { echo '0'; } else { echo $cancel_count->cancel_count; } ?></h4>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Total Order List <button type="button" class="btn btn-info send_all" style="float:right;margin-bottom:13px">Assign to</button>
             <div class="float-sm-right" style="margin-top: -3px;">
                 <form id="add_product" method="post" action="<?php echo base_url();?>sales/download_total_order_excel">
            ...
            <div class="card-body">
              ...
              <table id="total_sale_datatable" class="table table-bordered">
                <thead>
                    <tr>
