		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-4">
							<h5>Total Today Sales Amount : <?php if ($total_amount->total_amount == '') {
																echo '0';
															} else {
						...
						<div class="col-md-4">
							<h5>Total Previous Day Sales Amount : <?php if ($total_amount1->total_amount == '') {
																		echo '0';
																	} else {
																		echo $total_amount1->total_amount;
																	} ?></h5>
						</div>
