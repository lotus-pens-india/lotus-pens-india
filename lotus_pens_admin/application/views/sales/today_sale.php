  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Today Order</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Sales</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Today Order Tables</a></li>
            <li class="breadcrumb-item active" aria-current="page">Today Order Data Tables</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
       <div class="float-sm-right">
         <form id="add_product" method="post" action="<?php echo base_url();?>sales/download_excel">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Today Order List 
            ...
            <div class="card-body">
                <div class="row">
        		     <div class="col-md-4">
        		         <h5>Total Today Sales Amount : <?php if($total_amount->total_amount == '') { echo '0'; } else { echo $total_amount->total_amount; } ?></h5>
        		      </div>
        		      <div class="col-md-4">
        		         <h5>Total Previous Day Sales Amount : <?php if($total_amount1->total_amount == '') { echo '0'; } else { echo $total_amount1->total_amount; } ?></h5>
        		      </div>
              ...
              <table id="today_sale_datatable" class="table table-bordered">
                <thead>
                    <tr>
