  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-upload"></i> Saller Wise Sales Report</div>
            <div class="card-body">
			  <form id="add_product" method="post" action="<?php echo base_url();?>report/saller_wise_sales_report">
				...
				<hr>
        		 ...
        		 <div class="row">
        		     <div class="col-md-3">
        		      ...
        		      <div class="col-md-3">
        		           <form id="add_product" method="post" action="<?php echo base_url();?>sales/saller_wise_bussiness_download_excel">
