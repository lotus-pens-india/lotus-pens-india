...
<div class="content-wrapper">
	<div class="container-fluid">
		...
		<div class="row pt-2 pb-2">
			<div class="col-sm-9">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="javaScript:void();">Nib Tables</a></li>
					<li class="breadcrumb-item active" aria-current="page">Nib Data Tables</li>
				</ol>
			</div>
			<div class="col-sm-3">
				<div class="float-sm-right">
					...
					if ($login_type != '0') { ?>
						<button type="button" class="btn btn-primary waves-effect waves-light m-1" data-toggle="modal"
							data-target="#defaultsizemodal">Add NIB</button>
					<?php } ?>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header"><i class="fa fa-table"></i> NIB List</div>
					<div class="card-body">
									...
									if ($all_brand != '') {
										...
										foreach ($all_brand as $brand) {
											...
											<tr>
												...
												<td>
													...
													<a style="cursor:pointer;"
														...
														Onclick="return isActive(<?php echo $brand->id ?>,<?php echo $brand->status ?>);">
														<button type="button"
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<h5 class="modal-title"><i class="fa fa-star"></i> Update NIB</h5>
															<button type="button" class="close" data-dismiss="modal"
																aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<form id="update_nib<?php echo $brand->id ?>" method="post"
															action="<?php echo base_url(); ?>product/update_nib_data"
															enctype="multipart/form-data">
															<div class="modal-body">
																<div class="form-group">
																	<label for="input-1">Nib Name</label>
											...
											<script type="text/javascript">
												$(function () {
													$('#update_nib<?php echo $brand->id ?>').ajaxForm({
														beforeSend: function () {
															$('.form_error_msg').html('');
	...
	<div class="modal fade" id="defaultsizemodal">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title"><i class="fa fa-star"></i> Add NIB</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<form id="add_nib" method="post" action="<?php echo base_url(); ?>product/add_nib_data"
					enctype="multipart/form-data">
					<div class="modal-body">
						<div class="form-group">
							<label for="input-1">NIB Name</label>
							<input type="text" class="form-control" name="name" id="name" placeholder="Enter Nib Name">
							<div class="form_error_msg brand_nameError"></div>
						</div>
						<div class="form-group">
							<label for="input-1">USD Price</label>
	...
	<script type="text/javascript">
		function isActive(id, status) {
			if (confirm("Are you sure you want to delete this Record?")) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url(); ?>product/isActive",
