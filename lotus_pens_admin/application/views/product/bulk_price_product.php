  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Import price products</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Product</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Import price products</a></li>
         </ol>
	   </div>
	   <div class="col-sm-3">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-upload"></i> Import price products</div>
            <div class="card-body">
                ...
                <div id="wizard-vertical1">
                    ...
                    <section>
                        <div class="form-group row">
                          <div class="col-md-12">  
                          <form  method="post" action="<?php echo base_url();?>product/download_product_price_excel">
                            <p>Your bulk product price update data file should as per this template 
                        ...
                        <hr>
                      <form id="add_product" method="post" action="<?php echo base_url();?>product/import_product_price_data">
						<div class="form-group row">
