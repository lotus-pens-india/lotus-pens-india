                  ...
                  <div class="product-info">
                      ...
                      <div class="prod-color-options">
                          <div class="prod-options-slider " id="parent_div_of_color">
                              <div class="prod-options-slide" id="1_color" onclick="selectColor('1_color')">
                                  <p class="prod-color">Maroon</p>
                                  <img src="<?= base_url('assets/') ?>images/Pen 2.png" />
                              </div>
                              <div class="prod-options-slide" id="2_color" onclick="selectColor('2_color')">
                                  <p class="prod-color">Maroon</p>
                                  <img src="<?= base_url('assets/') ?>images/Pen 3.png" />
                              </div>
                              <div class="prod-options-slide" id="3_color" onclick="selectColor('3_color')">
                                  <p class="prod-color">Maroon</p>
                                  <img src="<?= base_url('assets/') ?>images/Pen 4.png" />
                              </div>
                              <div class="prod-options-slide" id="4_color" onclick="selectColor('4_color')">
                                  <p class="prod-color">Maroon</p>
                                  <img src="<?= base_url('assets/') ?>images/Pen 5.png" />
                              </div>
                              <div class="prod-options-slide" id="5_color" onclick="selectColor('5_color')">
                                  <p class="prod-color">Maroon</p>
